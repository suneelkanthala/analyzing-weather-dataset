...
def clear(df,col,val):
    ...
    """
    value_counts = df[df[col] == val][col].count()
    return value_counts
...
print(clear(weather,'Weather','Fog'))
...
print(wind_speed_35_vis_25['Wind Spd (km/h)'].value_counts())
print(wind_speed_35_vis_25['Visibility (km)'].value_counts())
...
print(agg_values_ina_month(weather,'Date/Time','Temp (C)', np.mean))
